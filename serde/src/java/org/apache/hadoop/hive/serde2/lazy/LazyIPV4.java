...
import org.apache.hadoop.hive.serde2.lazy.objectinspector.primitive.LazyIPV4ObjectInspector;
 ...
 */
public class LazyIPV4 extends LazyPrimitive<LazyIPV4ObjectInspector, Text> {

  public LazyIPV4(LazyIPV4ObjectInspector oi) {
    super(oi);
    data = new Text();
  }

  public LazyIPV4(LazyIPV4 copy) {
    super(copy);
